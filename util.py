...
def black(df):
    ...
    bl = [x.upper() for x in ['Argyll Scott','DBS','Manulife','Selby','EY','HKIP','Hang Seng','AXA', \
            ...
            'teksystems','Appointments','control automation','KDB Asia','Aptitude Asia','Crypto','Chong Hing', \
            'OKX','Seamatch','Hong Kong Applied Science and Technology Research','Consultants '
            ]]
